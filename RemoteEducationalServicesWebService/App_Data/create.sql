...
CREATE TABLE IF NOT EXISTS teacher_study_blocks (teacher_study_block_id INTEGER PRIMARY KEY AUTOINCREMENT,
										 user INTEGER NOT NULL,
										 FOREIGN KEY (user) REFERENCES users(userId));
...
CREATE TABLE IF NOT EXISTS study_blocks  (study_blocks_id INTEGER PRIMARY KEY AUTOINCREMENT,
										 ...
										 user INTEGER NOT NULL,
										 FOREIGN KEY (week_block) REFERENCES teacher_study_blocks(teacher_study_block_id),
										 FOREIGN KEY (user) REFERENCES users(userId));
